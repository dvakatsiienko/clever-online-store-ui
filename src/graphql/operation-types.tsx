...
export type OrderQuery = { __typename?: 'Query' } & {
    order?: Maybe<{ __typename?: 'Order' } & OrderFragment>;
};

export type AllOrdersQueryVariables = Exact<{ [key: string]: never }>;

export type AllOrdersQuery = { __typename?: 'Query' } & {
    allOrders?: Maybe<Array<Maybe<{ __typename?: 'Order' } & OrderFragment>>>;
};
...
export type CheckoutMutation = { __typename?: 'Mutation' } & {
    checkout?: Maybe<
        { __typename?: 'Order' } & Pick<Order, 'id' | 'charge' | 'total'> & {
                items: Array<
...
export type ProductsCountQuery = { __typename?: 'Query' } & {
...
export type AddToCartMutation = { __typename?: 'Mutation' } & {
    addToCart?: Maybe<{ __typename?: 'CartItem' } & Pick<CartItem, 'id'>>;
};
...
export type RemoveFromCartMutation = { __typename?: 'Mutation' } & {
    deleteCartItem?: Maybe<{ __typename?: 'CartItem' } & Pick<CartItem, 'id'>>;
};
...
export type ProductsCountQueryHookResult = ReturnType<
    typeof useProductsCountQuery
>;
export type ProductsCountLazyQueryHookResult = ReturnType<
    typeof useProductsCountLazyQuery
>;
export type ProductsCountQueryResult = Apollo.QueryResult<
    ProductsCountQuery,
    ProductsCountQueryVariables
>;
...
export type TypedTypePolicies = TypePolicies & {
    ...
    OrderItem?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
        keyFields?:
            | false
            | OrderItemKeySpecifier
            | (() => undefined | OrderItemKeySpecifier);
    ...
    SendUserPasswordResetLinkResult?: Omit<
        TypePolicy,
        'fields' | 'keyFields'
    > & {
        keyFields?:
